...
namespace GNet.Lib
{
    public partial class G13Device : IDisposable
    {
        ...
        G13Device()
        {
            ...
            lcd = new Lcd("G13 GNet Profiler", false, false, LcdDeviceType.LcdDeviceBW);
            if (!lcd.Init())
            {
                lcd = null;
        ...
        {
            Console.WriteLine("G13 Connected");
            if (Inserted != null)
                Inserted();
        }
        ...
        {
            Console.WriteLine("G13 Disconnected");
            if (Removed != null)
                Removed();
        }
